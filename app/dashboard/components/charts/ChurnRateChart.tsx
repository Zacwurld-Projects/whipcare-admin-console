...
const ChurnRateChart = () => {
  return (
    <div className={`mb-[10px] rounded-lg border border-gray-200 bg-white px-[22px] py-[15px]`}>
      <div className='flex justify-between'>
        <p className='text-large text-gray-500'>Churn Rate</p>
        <p className='text-medium self-end rounded-[2em] bg-[#bcf0da] px-3 py-[3px] text-gray-600'>
          +{Math.round(((4.26 - 4.25) / 4.25) * 100 * 100) / 100}%
        </p>
      </div>
      <p className='text-2xl font-semibold text-gray-600'>4.26%</p>
