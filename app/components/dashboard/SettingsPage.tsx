...
function NoMemberIllustration() {
  return (
    <svg width="87" height="93" viewBox="0 0 87 93" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M56.8287 11.3672C62.2446 11.3672 66.5996 15.8284 66.5996 21.3125C66.5996 26.683 62.4121 31.0589 57.1917 31.2578C56.9683 31.2294 56.7171 31.2294 56.4658 31.2578" stroke="#F77A4A" strokeWidth="1.79464" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <path d="M62.2168 56.8304C64.2268 56.4041 66.1251 55.5801 67.6885 54.3582C72.0435 51.0337 72.0435 45.5495 67.6885 42.225C66.153 41.0315 64.2826 40.2359 62.3005 39.7812" stroke="#F77A4A" strokeWidth="1.79464" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
