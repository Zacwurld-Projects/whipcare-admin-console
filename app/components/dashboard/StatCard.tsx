    ...
    <div className="rounded-xl border border-slate-100 bg-white p-5">
      <div className="flex items-center gap-2">
        <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M0.5 13.1693C1.38836 13.5842 2.55529 13.8359 3.83333 13.8359C5.11138 13.8359 6.27831 13.5842 7.16667 13.1693C8.05503 12.7544 9.22195 12.5026 10.5 12.5026C11.778 12.5026 12.945 12.7544 13.8333 13.1693" stroke="#1E2939" stroke-linecap="round" />
          ...
          <path d="M2.8335 6.83594L2.8335 6.84193" stroke="#1E2939" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M11.5 5.49219L11.5 5.49818" stroke="#1E2939" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
